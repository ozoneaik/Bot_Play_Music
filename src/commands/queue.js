...
module.exports = {
    ...
    execute(client, message) {
        ...
        if (!queue || !queue.playing) return message.channel.send(`❌ | ไม่มีเพลงในคิวในขณะนี้ครับ`);
        ...
        return message.channel.send({ embeds: [embed.Embed_queue("รายการคิว", nowplay, queueMsg, loopStatus)] });
    },
};